...
export function MailCompose({ onSendMail }) {
    ...
    return <div className="mail-compose-container ">
        <form className="main-compose-form flex column" onSubmit={handleMailSubmit}>
            ...
            <input className="recipients" name="to" type="email" id="recipients" placeholder="To" onChange={handleChange} />
            ...
            <div className="send-btn-n"><button className="send-btn"> Send</button></div>
        </form>
    </div>
}