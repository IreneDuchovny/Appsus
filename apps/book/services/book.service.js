...
function getEmptyBook(title = '', subtitle = '', authors = [], description = '', pageCount = '', categories = [], thumbnail = '', language = '', publishedDate = '', price = '', currency = '', isOnSale = false) {
  return { title, listPrice: { amount: price, currencyCode: currency, isOnSale }, subtitle, authors, description, pageCount, categories, thumbnail, language, publishedDate }
}
...
function _createBook(title, price, currency, isOnSale) {
  const book = getEmptyBook(title, price, currency, isOnSale)
