...
<br/>
            ...
            <div className="team-section flex ">
                <div className="team-member">
                    ...
                    <a href="https://github.com/IreneDuchovny" target="_blank"><i className="fab fa-github"></i>
                ...
                <div className="team-member">
                    ...
                    {/* <a href="https://linkedin.com/in/bob"  target="_blank"> <i className="fab fa-linkedin"></i> */}
                        {/* <img src="linkedin-icon.png" alt="LinkedIn" /> */}
                    {/* </a> */}
                </div>
            </div>
